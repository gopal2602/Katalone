...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Companies/btncreatecompany'), 'value', 'Create Company', 10)
WebUI.submit(findTestObject('Object Repository/Companies/btncreatecompany'), FailureHandling.STOP_ON_FAILURE)